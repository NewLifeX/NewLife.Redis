...
🌐 [English](Readme.en.md) | [日本語](README.ja.md) | [한국어](README.ko.md) | [Español](README.es.md) | [Français](README.fr.md) | [Deutsch](README.de.md) | [Русский](README.ru.md)
...
- [ ] UNLINK 异步删除
- [ ] Prometheus 指标导出适配器
- [x] 阿里云 Tair 扩展（TairString / TairHash 已支持，TairZSet 规划中）
- [ ] 华为云 DCS 集群版节点地址映射适配
- [x] ~~发布订阅 PubSub~~（已完成）
